 ...
 */
public class RoomOneView extends View {
    ...
    public String[] getInputs() {
          ...
          String value = this.getInput("Would you like to pick up the sand and two litrer bottle. Y or N");
          inputs[0] = value;
    ...
    public boolean doAction(String[] inputs) {
       ...
       if (value.equals("Y")) {
          ...
          itemsFound.add(Inventory.Sand);
          itemsFound.add(Inventory.TwoLiterBottle);
